...
if __name__ == '__main__':
    ...
    if args.danfonis:
        danfonis_strategy = danfonis(num_users=args.num_users)
    ...
    for seed in gargs.seed:
        ...
        for epoch in tqdm(range(args.epochs)):
            ...
            #Integramos danfonis
                ...
                # Use danfonis strategy
                data_loaders = [DataLoader(DatasetSplit(train_dataset, user_groups[idx]), batch_size=args.local_bs, shuffle=True)
                                for idx in range(args.num_users)]
                idxs_users = danfonis_strategy.select_clients(user_groups, m, data_loaders)
                print("danfonis Chosen Clients:", idxs_users)
