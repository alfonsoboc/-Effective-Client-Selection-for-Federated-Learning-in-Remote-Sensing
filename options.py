...
def args_parser():
    ...
    #Argument for using FedSignal, here called danfonis
    parser.add_argument('--danfonis', action='store_true', help='Use FedSignal client selection strategy')
    ...
    # Daniel arguments IGNORE, ITS OBSOLETE
    parser.add_argument('--eurosat_iid', type=str, default=None, 
                        help="type_of_iidness: 'iid', 'partial', 'noniid'")
    # utils arguments
